...
public class DriveTrain extends Subsystem {
	...
	public DriveTrain() {
		...
		leftTalon.configPeakOutputForward(1, 10);	//Use for extrasensitive CB //0.6
		leftTalon.configPeakOutputReverse(-1, 10); //Use for extrasensitive CB //-0.6
		...
		rightTalon.configPeakOutputForward(1, 10);  //Use for extrasensitive CB
		rightTalon.configPeakOutputReverse(-1, 10); //Use for extrasensitive CB
