...
public class MotionProfileExample {
	...
	private void startFilling() {
		...
		startFilling(MotionProfileTrajectory.Points, MotionProfileTrajectory.kNumPoints); //TODO GENERATE PLEZ
	}
	...
	private void startFilling(double[][] profile, int totalCnt) {
		...
		_talon.configMotionProfileTrajectoryPeriod(RobotMap.MPConstants.kBaseTrajPeriodMs, RobotMap.MPConstants.kTimeoutMs);
		...
		for (int i = 0; i < totalCnt; ++i) {
			...
			point.position = positionRot * RobotMap.MPConstants.kSensorUnitsPerRotation; //Convert Revolutions to Units
			point.velocity = velocityRPM * RobotMap.MPConstants.kSensorUnitsPerRotation / 600.0; //Convert RPM to Units/100ms
