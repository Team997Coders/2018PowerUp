...
public class AutoCenterSwitchDelivery extends CommandGroup {
    ...
    public AutoCenterSwitchDelivery() {
    	...
    	if(Robot.getGameData().charAt(0) == 'L') {
    		...
    		addSequential(new PDriveToDistance(5.5 * RobotMap.Values.ticksPerFoot)); //Diagonal length towards our switch.
    		...
    		addSequential(new PDriveToDistance(4.15 * RobotMap.Values.ticksPerFoot)); //Drive to reach switch for cube delivery.
    		//PRETTY ACCURATE NOW!!:^)
