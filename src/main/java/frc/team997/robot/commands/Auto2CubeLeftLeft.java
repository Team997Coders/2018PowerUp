...
public class Auto2CubeLeftLeft extends CommandGroup {
    ...
    public Auto2CubeLeftLeft() {
    	...
    	addSequential(new ElevatorToHeight(RobotMap.Values.elevatorTopHeight - 2000)); //elevatorTopHeight
    	addSequential(new Timercommand(1));
    	addSequential(new PDriveToAngle(90)); //45
